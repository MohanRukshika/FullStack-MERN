        ...
        <div className="w-screen h-screen fixed bg-secondary/30 top-0 left-0 flex items-center justify-center z-[99]">
          ...
          <div className="w-[600px] h-[650px] bg-white rounded-md shadow-lg flex flex-col relative overflow-hidden">
            ...
            <div className="border-t border-gray-300 px-5 py-3 shrink-0">
              ...
              {/* Notes + Status + Update */}
              <div className="flex mt-1 justify-between items-end gap-3">
                ...
                <div className="w-1/2">
                  ...
                  <textarea
                    value={notes}
                    className="w-full h-10 px-3 py-1.5 text-sm text-gray-700 bg-accent/10 rounded resize-none" onChange={(e)=>setNotes(e.target.value)}
                  />
                ...
                <div>
                  ...
                  <select
                    value={status}
                    className="px-3 py-1 bg-accent/10 text-gray-900 rounded h-10" onChange={(e)=>setStatus(e.target.value)}
                  >
                ...
                {/* Update Button */}
                <button
                  className="h-10 bg-accent border-2 rounded-2xl px-3 text-white"
                  onClick={updateOrder} disabled={isUpdating}
                >
